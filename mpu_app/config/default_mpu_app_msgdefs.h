 ...
 *
 *  For MPU_APP this is only the function/command code definitions
 */
#ifndef MPU_APP_MSGDEFS_H
#define MPU_APP_MSGDEFS_H

#include "common_types.h"
#include "mpu_app_fcncodes.h"

typedef struct MPU_APP_DisplayParam_Payload
{
...
*/
/*************************************************************************/
typedef struct MPU_APP_HkTlm_Payload
{
