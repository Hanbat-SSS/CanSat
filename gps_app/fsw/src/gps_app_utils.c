...
/**
 * \file
 *   This file contains the source code for the Gps App utility functions
 */
...
CFE_Status_t GPS_APP_TblValidationFunc(void *TblData)
{
    ...
    GPS_APP_ExampleTable_t *TblDataPtr = (GPS_APP_ExampleTable_t *)TblData;

    /*
    ** Gps Example Table Validation
    */
...
void GPS_APP_GetCrc(const char *TableName)
{
    ...
    {
        CFE_ES_WriteToSysLog("Gps App: Error Getting Example Table Info");
    }
    else
    {
        Crc = TblInfoPtr.Crc;
